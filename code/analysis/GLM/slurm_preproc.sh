...
#SBATCH --output='/jukebox/graziano/coolCatIsaac/ATM/code/preprocessing/logs/n28-isc_preproc-%A_%a.log'
...
cd /jukebox/graziano/coolCatIsaac/ATM/code/analysis/preproc/
chmod +x slurm_create-data_preproc_ISC.py
./slurm_create-data_preproc_ISC.py
