...
do
    # **Change me** # 
    b4='3dttest_omoc_n26_between_4fhwm_hp001p25-excOvlp_'
    suf='_zmap'
    pref=${b4}${cont}${suf}
    echo $cont
    echo $pref
...
-setA Differnces sub-000	sub-000_OM-OC_between_${cont}_zmap.nii	\
sub-001	sub-001_OM-OC_between_${cont}_zmap.nii	\
sub-002	sub-002_OM-OC_between_${cont}_zmap.nii	\
sub-003	sub-003_OM-OC_between_${cont}_zmap.nii	\
sub-004	sub-004_OM-OC_between_${cont}_zmap.nii	\
sub-005	sub-005_OM-OC_between_${cont}_zmap.nii	\
sub-006	sub-006_OM-OC_between_${cont}_zmap.nii	\
sub-007	sub-007_OM-OC_between_${cont}_zmap.nii	\
sub-008	sub-008_OM-OC_between_${cont}_zmap.nii	\
sub-009	sub-009_OM-OC_between_${cont}_zmap.nii	\
sub-010	sub-010_OM-OC_between_${cont}_zmap.nii	\
sub-011	sub-011_OM-OC_between_${cont}_zmap.nii	\
sub-013	sub-013_OM-OC_between_${cont}_zmap.nii	\
sub-014	sub-014_OM-OC_between_${cont}_zmap.nii	\
sub-015	sub-015_OM-OC_between_${cont}_zmap.nii	\
sub-016	sub-016_OM-OC_between_${cont}_zmap.nii	\
sub-017	sub-017_OM-OC_between_${cont}_zmap.nii	\
sub-018	sub-018_OM-OC_between_${cont}_zmap.nii	\
sub-020	sub-020_OM-OC_between_${cont}_zmap.nii	\
sub-021	sub-021_OM-OC_between_${cont}_zmap.nii	\
sub-022	sub-022_OM-OC_between_${cont}_zmap.nii	\
sub-023	sub-023_OM-OC_between_${cont}_zmap.nii	\
sub-024	sub-024_OM-OC_between_${cont}_zmap.nii	\
sub-025	sub-025_OM-OC_between_${cont}_zmap.nii	\
sub-026	sub-026_OM-OC_between_${cont}_zmap.nii	\
sub-027	sub-027_OM-OC_between_${cont}_zmap.nii	\
-Clustsim \
-tempdir $tem_dir
