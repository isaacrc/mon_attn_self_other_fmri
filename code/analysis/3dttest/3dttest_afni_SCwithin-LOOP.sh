...
do
    # **Change me** # 
    b4='3dttest_sc_n26_within_4fhwm_hp001-lp25-excOvlp_'
    suf='_zmap'
    pref=${b4}${cont}${suf}
    echo $cont
    echo $pref
...
-setA Differnces sub-000	sub-000_SC_within_${cont}_zmap.nii	\
sub-001	sub-001_SC_within_${cont}_zmap.nii	\
sub-002	sub-002_SC_within_${cont}_zmap.nii	\
sub-003	sub-003_SC_within_${cont}_zmap.nii	\
sub-004	sub-004_SC_within_${cont}_zmap.nii	\
sub-006	sub-006_SC_within_${cont}_zmap.nii	\
sub-007	sub-007_SC_within_${cont}_zmap.nii	\
sub-009	sub-009_SC_within_${cont}_zmap.nii	\
sub-010	sub-010_SC_within_${cont}_zmap.nii	\
sub-011	sub-011_SC_within_${cont}_zmap.nii	\
sub-012	sub-012_SC_within_${cont}_zmap.nii	\
sub-013	sub-013_SC_within_${cont}_zmap.nii	\
sub-014	sub-014_SC_within_${cont}_zmap.nii	\
sub-015	sub-015_SC_within_${cont}_zmap.nii	\
sub-016	sub-016_SC_within_${cont}_zmap.nii	\
sub-017	sub-017_SC_within_${cont}_zmap.nii	\
sub-018	sub-018_SC_within_${cont}_zmap.nii	\
sub-019	sub-019_SC_within_${cont}_zmap.nii	\
sub-020	sub-020_SC_within_${cont}_zmap.nii	\
sub-021	sub-021_SC_within_${cont}_zmap.nii	\
sub-022	sub-022_SC_within_${cont}_zmap.nii	\
sub-023	sub-023_SC_within_${cont}_zmap.nii	\
sub-024	sub-024_SC_within_${cont}_zmap.nii	\
sub-025	sub-025_SC_within_${cont}_zmap.nii	\
sub-026	sub-026_SC_within_${cont}_zmap.nii	\
sub-027	sub-027_SC_within_${cont}_zmap.nii	\
-Clustsim \
-tempdir $tem_dir
