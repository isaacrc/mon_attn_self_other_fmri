...
do
    # **Change me** # 
    b4='3dttest_sm_n26_within_4fhwm_hp001-lp25-excOvlp_'
    suf='_zmap'
    pref=${b4}${cont}${suf}
    echo $cont
    echo $pref
...
-setA Differnces sub-000	sub-000_SM_within_${cont}_zmap.nii	\
sub-001	sub-001_SM_within_${cont}_zmap.nii	\
sub-002	sub-002_SM_within_${cont}_zmap.nii	\
sub-003	sub-003_SM_within_${cont}_zmap.nii	\
sub-004	sub-004_SM_within_${cont}_zmap.nii	\
sub-006	sub-006_SM_within_${cont}_zmap.nii	\
sub-007	sub-007_SM_within_${cont}_zmap.nii	\
sub-009	sub-009_SM_within_${cont}_zmap.nii	\
sub-010	sub-010_SM_within_${cont}_zmap.nii	\
sub-011	sub-011_SM_within_${cont}_zmap.nii	\
sub-012	sub-012_SM_within_${cont}_zmap.nii	\
sub-013	sub-013_SM_within_${cont}_zmap.nii	\
sub-014	sub-014_SM_within_${cont}_zmap.nii	\
sub-015	sub-015_SM_within_${cont}_zmap.nii	\
sub-016	sub-016_SM_within_${cont}_zmap.nii	\
sub-017	sub-017_SM_within_${cont}_zmap.nii	\
sub-018	sub-018_SM_within_${cont}_zmap.nii	\
sub-019	sub-019_SM_within_${cont}_zmap.nii	\
sub-020	sub-020_SM_within_${cont}_zmap.nii	\
sub-021	sub-021_SM_within_${cont}_zmap.nii	\
sub-022	sub-022_SM_within_${cont}_zmap.nii	\
sub-023	sub-023_SM_within_${cont}_zmap.nii	\
sub-024	sub-024_SM_within_${cont}_zmap.nii	\
sub-025	sub-025_SM_within_${cont}_zmap.nii	\
sub-026	sub-026_SM_within_${cont}_zmap.nii	\
sub-027	sub-027_SM_within_${cont}_zmap.nii	\
-Clustsim \
-tempdir $tem_dir
