...
### This is already corrected in raw output! Don't need to do
...
run1="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-01_bold.nii.gz"\","
run2="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-02_bold.nii.gz"\","
run3="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-03_bold.nii.gz"\","
run4="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-04_bold.nii.gz"\","
run5="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-05_bold.nii.gz"\","
run6="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-06_bold.nii.gz"\","
run7="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-07_bold.nii.gz"\","
run8="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-08_bold.nii.gz"\","
run9="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-09_bold.nii.gz"\","
run10="\""ses-01/func/sub-${subj}_ses-01_task-Attn_run-10_bold.nii.gz"\""
end="],"
