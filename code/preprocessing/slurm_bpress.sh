...
#SBATCH --output='/jukebox/graziano/coolCatIsaac/ATM/code/preprocessing/logs/bpress-%A_%a.log'
...
chmod +x ATM_bpress_betaVal_SM-SC_5-23-22.py
./ATM_bpress_betaVal_SM-SC_5-23-22.py
