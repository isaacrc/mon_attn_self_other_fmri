...
#SBATCH --output='/jukebox/graziano/coolCatIsaac/ATM/data/work/workspace/logs/savdata-%A_%a.log'
...
cd /jukebox/graziano/coolCatIsaac/ATM/code/analysis/corr/
chmod +x slurm_create-data_preproc.py
./slurm_create-data_preproc.py
